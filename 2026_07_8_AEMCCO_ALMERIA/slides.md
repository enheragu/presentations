...
--- depth:0 center portada
<div class="pita-plant" aria-hidden="true"><img class="a-base" src="assets/pita_base.png" alt=""><img class="a-s1" src="assets/pita_s1.png" alt=""><img class="a-s2" src="assets/pita_s2.png" alt=""><img class="a-s3" src="assets/pita_s3.png" alt=""></div>
<div class="portada-top"><img class="congress-title" src="assets/congress-title.png" alt="XIX Congreso de Metodología de las Ciencias Sociales y de la Salud"><img class="congress-wordmark" src="assets/congress-wordmark.png" alt="AEMCCO"><div class="meta" style="font-size:clamp(.8rem,1.7vw,1.12rem)">7–9 Julio 2026 <span class="sep">·</span> Universidad de Almería</div></div>
<div class="portada-mid"><div class="talk-title">Que no te engañe el azar</div><div class="talk-sub">Cómo impacta la aleatoriedad en el diseño de redes neuronales</div></div>
<div class="portada-bot"><div class="talk-authors"><span class="me">Enrique Heredia-Aguado</span> · Alejandro Rujano · David Valiente · Arturo Gil</div><div class="talk-affil">Universidad Miguel Hernández de Elche <span class="sep">·</span> UNED</div><div class="inst-logos"><span class="lchip"><img src="assets/logo-i3e.png" alt="I3E · Universidad Miguel Hernández" onerror="this.closest('.lchip').style.display='none'"></span><span class="lchip"><img src="assets/logo-uned.jpg" alt="UNED" onerror="this.closest('.lchip').style.display='none'"></span></div></div>
...
<div class="anova-note">5 parametrizaciones × 400 semillas = <b>2000 entrenos</b>: el techo es <b>99.66 %</b>. El 99.75 % reportado no lo alcanza ninguna receta estándar.</div>
...
Análisis:
<ul class="bullets">
<li>ANOVA y descomposición de varianza.</li>
</ul>
...
> Caso 2: mejorando modelos <span class="ktag">SparseMLP</span>
...
<div style="display:flex;align-items:stretch;justify-content:center;gap:2.8em;margin-top:1.6em">
  ...
  <div style="flex:1;max-width:545px;display:flex;flex-direction:column;align-items:center">
    ...
    <svg viewBox="0 0 330 200" style="width:100%;max-width:515px;height:auto">
      <g style="stroke:rgba(var(--ink),.28);stroke-width:1.3;fill:none">
        ...
        <path d="M278 96 L52 132"/><path d="M278 96 L165 132"/><path d="M278 96 L278 132"/>
      </g>
      <g style="stroke:#009e73;stroke-width:2.6;fill:none">
        <path d="M165 34 L278 68"/><path d="M278 96 L165 132"/>
      </g>
      ...
      <text x="165" y="149" text-anchor="middle" style="fill:rgb(var(--ink));font:700 11px system-ui">E 20</text>
      <rect x="249" y="132" width="58" height="26" rx="8" style="fill:rgba(var(--ink),.05);stroke:rgba(var(--ink),.28);stroke-width:1.2"/>
      <text x="278" y="149" text-anchor="middle" style="fill:rgb(var(--ink));font:600 11px system-ui">E 40</text>
    </svg>
  ...
  <div style="flex:1;max-width:545px;display:flex;flex-direction:column;align-items:center">
    ...
    <div style="display:flex;align-items:center;gap:.5em;margin-top:.3em">
      <div style="writing-mode:vertical-rl;transform:rotate(180deg);font:600 .86rem system-ui;letter-spacing:.04em;color:rgba(var(--ink),.6)">epsilon</div>
      <div style="display:inline-grid;grid-template-columns:36px repeat(3,92px);grid-template-rows:repeat(3,70px) 24px;gap:10px;place-items:center">
        <div style="font:700 1rem system-ui;color:rgba(var(--ink),.7)">10</div>
        <div class="ablcell">800</div><div class="ablcell">800</div><div class="ablcell">800</div>
        <div style="font:700 1rem system-ui;color:rgba(var(--ink),.7)">20</div>
        <div class="ablcell">800</div><div class="ablcell">800</div><div class="ablcell">800</div>
        <div style="font:700 1rem system-ui;color:rgba(var(--ink),.7)">40</div>
        <div class="ablcell">800</div><div class="ablcell">800</div><div class="ablcell">800</div>
        <div></div>
...
<div class="widget" data-widget="ablation-tree" data-case="b3" data-axis="col"></div>

--- depth:0.6 nobrand wide
> Caso 2: mejorando modelos <span class="ktag">SparseMLP</span>
## Estudios de ablación: ¿Interacción <span class="accent">E×L</span>?

<div class="anova-row">
<div class="widget" data-widget="interaction-plot" data-case="b3"></div>
<div class="widget" data-widget="anova-table" data-source="anova_ablation"></div>
</div>

<div class="anova-note">El peso de cada factor se mide, no se supone: puede ser decisivo o casi nulo (η²≈0), y depende del modelo. <b>No se sabe a priori.</b></div>
...
<div class="anova-note">Descomposición <b>descriptiva</b> de la varianza (η²): cuánto pesa cada fuente en la rejilla. Como el entrenamiento es determinista dadas las semillas (MSE bit-idéntico al repetir), la interacción <b>no es ruido: es estructura real</b>.</div>

--- depth:0.35 nobrand bodyc zenqr
> Recursos
## Reprodúcelo tú mismo

**Demos interactivas** basadas en los datos **CPC18** así como los ejemplos de visión por computadora.


--- depth:0.05 nobrand bodyc zenqr
> Conclusión
## ¿Y ahora qué?

No dejarse llevar por el azar, pero sí podemos surfearlo (y reportarlo).
Así mejoraremos la **reproducibilidad, la comparabilidad** y las fuentes de evidencia de **validez de las conclusiones** extraídas<sup class="fn-ref">1</sup>.

<div class="footnote"><sup>1</sup> Alicia, espero que así esté bien dicho.</div> 

--- depth:0 center portada
<div class="pita-plant" aria-hidden="true"><img class="a-base" src="assets/pita_base.png" alt=""><img class="a-s1" src="assets/pita_s1.png" alt=""><img class="a-s2" src="assets/pita_s2.png" alt=""><img class="a-s3" src="assets/pita_s3.png" alt=""></div>
<div class="portada-top"><div class="end-congress">XIX Congreso de Metodología de las<br>Ciencias Sociales y de la Salud <span class="sep">·</span> AEMCCO</div></div>
<div class="portada-mid"><div class="wordmark thanks"><span class="t">Graci</span><span class="m">a</span><span class="d">s</span></div><div class="qr-block" style="margin-top:.5em"><img id="zenqrHome" style="visibility:hidden" src="assets/qr-mlv.png" alt="QR mlv-tools"><div class="qr-label">mlv-tools · (10.5281/zenodo.20268237)</div></div><div class="contact">e.heredia@umh.es</div></div>
<div class="portada-bot"><div class="talk-title">Que no te engañe el azar</div><div class="talk-authors"><span class="me">Enrique Heredia-Aguado</span> · Alejandro Rujano · David Valiente · Arturo Gil</div><div class="talk-affil">Universidad Miguel Hernández de Elche (I3E) <span class="sep">·</span> UNED</div><div class="inst-logos inst-logos--sm"><span class="lchip"><img src="assets/logo-i3e.png" alt="I3E · Universidad Miguel Hernández" onerror="this.closest('.lchip').style.display='none'"></span><span class="lchip"><img src="assets/logo-uned.jpg" alt="UNED" onerror="this.closest('.lchip').style.display='none'"></span></div></div>
